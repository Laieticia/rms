                    ...
                    <div class="col-lg-12">
                        <div class="d-flex flex-wrap flex-wrap align-items-center justify-content-between mb-4">
                            <div>
                                ...
                                <p class="mb-0">The menu list effectively dictates menu presentation and provides
                                    space<br> to list your menus and offering in the most appealing way.</p>
                            </div>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div>
                                                    Organic Cream
                                                    <p class="mb-0"><small>This is test Menu</small></p>
                                                </div>
                                            </div>
                                        </td>
                                        <td>CREM01</td>
