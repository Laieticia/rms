        ...
        <nav class="navbar navbar-expand-lg navbar-light p-0">
            <div class="iq-navbar-logo d-flex align-items-center justify-content-between">
                ...
                <a href="<?php echo e(route('admin.dashboard')); ?>" class="header-logo">
                    <img src="<?php echo e(url('admin/assets/images/logo.png')); ?>" class="img-fluid rounded-normal" alt="logo">
                    <h5 class="logo-title ml-3">MontRoyal</h5>
                </a>
            </div>
            <div class="iq-search-bar device-search">
                <form action="<?php echo e(route('admin.products.index')); ?>" method="GET" class="searchbox">
                    ...
                    <ul class="navbar-nav ml-auto navbar-list align-items-center">
                        <li class="nav-item nav-icon search-content">
                            ...
                            <div class="iq-search-bar iq-sub-dropdown dropdown-menu" aria-labelledby="dropdownSearch">
                                <form action="<?php echo e(route('admin.products.index')); ?>" method="GET" class="searchbox p-2">
                        ...
                        <li class="nav-item nav-icon dropdown" id="notificationBell">
                            <a href="#" class="search-toggle dropdown-toggle" id="dropdownMenuButton"
                                ...
                                <span id="notificationBadge" class="badge bg-danger rounded-pill position-absolute"
                                    style="top:0;right:0;font-size:10px;<?php echo e(auth()->user()->notifications()->where('is_read', false)->count() === 0 ? 'display:none;' : ''); ?>">
                                    ...
                                    <div class="card-body p-0">
                                        ...
                                        <div class="px-3 pt-0 pb-0 sub-card" id="notificationList" style="max-height:300px;overflow-y:auto;">
                                            ...
                                            <?php $__empty_1 = true; $__currentLoopData = $notifications; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $notif): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                                <a href="#" class="iq-sub-card notification-item <?php echo e($notif->is_read ? '' : 'bg-light'); ?>"
                                                   data-id="<?php echo e($notif->id); ?>"
                                                   data-url="<?php echo e($notif->action_url ?? ''); ?>">
                                                    <div class="media align-items-center cust-card py-3 border-bottom">
                                                        ...
                                                        <div class="media-body ml-3">
                                                            <div class="d-flex align-items-center justify-content-between">
                                                                <h6 class="mb-0"><?php echo e($notif->title); ?></h6>
                                                                <small class="text-dark"><b><?php echo e($notif->created_at->format('H:i')); ?></b></small>
                                                            </div>
                                                            <small class="mb-0"><?php echo e(Str::limit($notif->message, 50)); ?></small>
                                                        </div>
                                                    </div>
                                                </a>
                                        ...
                                        <a class="right-ic btn btn-primary btn-block position-relative p-2"
                                           href="<?php echo e(route('admin.notifications.index')); ?>" role="button">
                        ...
                        <li class="nav-item nav-icon dropdown caption-content">
                            <a href="#" class="search-toggle dropdown-toggle" id="dropdownMenuButton4"
                                data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <img src="<?php echo e(auth()->user()->avatar_url ?? url('admin/assets/images/user/1.png')); ?>" class="img-fluid rounded" alt="user">
                            </a>
                            <div class="iq-sub-dropdown dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenuButton4">
                                <div class="card shadow-none m-0">
                                    <div class="card-body p-0 text-center">
                                        <div class="media-body profile-detail text-center">
                                            <img src="<?php echo e(url('admin/assets/images/page-img/profile-bg.jpg')); ?>" alt="profile-bg"
                                                class="rounded-top img-fluid mb-4">
                                            <img src="<?php echo e(auth()->user()->avatar_url ?? url('admin/assets/images/user/1.png')); ?>" alt="profile-img"
                                                class="rounded profile-img img-fluid avatar-70">
                                        </div>
                                        <div class="p-3">
                                            <h5 class="mb-1"><?php echo e(auth()->user()->name); ?></h5>
                                            <p class="mb-0 text-muted small"><?php echo e(auth()->user()->email); ?></p>
                                            <div class="d-flex align-items-center justify-content-center mt-3">
                                                <a href="<?php echo e(route('profile.index')); ?>" class="btn border mr-2">Profil</a>
...
<?php /**PATH C:\Users\hdcode\Documents\hdcode\backend\2026\news2026\rms\resources\views/layouts/header.blade.php ENDPATH**/ ?>